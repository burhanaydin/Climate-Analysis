...
public class CurveFitting implements UserFunction{
	/** Constants for the available fit functions */
	...
	/** Nicer sequence of the available function types */
	...
	/** Names of the available fit functions */
	...
	/** Equations of the available fit functions */	
	...
	public CurveFitting (double[] xData, double[] yData) {
		this.xData = xData;
		this.yData = yData;
		numPoints = xData.length;
	}
	
	/** Perform curve fitting with one of the available functions
	...
	/** Returns value of available 'fitType' formula value for parameters "p" at "x" */
	 ...
	 *	modified before fitting (power&exp fit by linear regression).
	...
	*/
	...
	public String getResultString() {
		...
		resultS += "\nTime: "+time+" ms" +
				"\nSum of residuals squared: " + d2s(getSumResidualsSqr(),5,9) +
				"\nStandard deviation: " + d2s(getSD(),5,9) +
				"\nR^2: " + d2s(getRSquared(),5) +
				"\nParameters:";
		char pChar = 'a';
	...
	/** Estimate values for initial parameters and their typical range for the available
	...
	/** Set multiplyParams and offsetParam for available functions. This allows us to use linear
